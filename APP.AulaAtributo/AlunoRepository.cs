...
namespace APP.AulaAtributo
{
    public class AlunoRepository
    {
        ...
        private void GetAluno()
        {
            ...
            EtiquetaAttribute nomeetiqueAttribute = (EtiquetaAttribute)
                Attribute.GetCustomAttribute(nomeProperty, typeof(EtiquetaAttribute));
            EtiquetaAttribute matriculaetiqueAttribute = (EtiquetaAttribute)
                Attribute.GetCustomAttribute(matriculaProperty, typeof(EtiquetaAttribute));
