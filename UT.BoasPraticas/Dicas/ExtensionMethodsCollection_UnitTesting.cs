...
{
    [TestClass]
    class ExtensionMethodsCollection_UnitTesting
    {
        [TestMethod]
    ...
    static class LutadoresPersistenciaExtension
    {
        public static Lutador Add(this ColecaoSimples colecao, Lutador lutador)
        {
            colecao.Add(lutador);
            return lutador;
        }
